...
#define   TAL_BRKSTATUS_CM0P_INT_RUN_Val  _U_(0x0)   /**< \brief (TAL_BRKSTATUS) CM0P running, by internal request */
#define   TAL_BRKSTATUS_CM0P_INT_HALT_Val _U_(0x1)   /**< \brief (TAL_BRKSTATUS) CM0P halted, by internal request */
#define   TAL_BRKSTATUS_CM0P_EXT_RUN_Val  _U_(0x2)   /**< \brief (TAL_BRKSTATUS) CM0P running, by external request */
#define   TAL_BRKSTATUS_CM0P_EXT_HALT_Val _U_(0x3)   /**< \brief (TAL_BRKSTATUS) CM0P halted, by external request */
...
#define   TAL_BRKSTATUS_PPP_INT_RUN_Val   _U_(0x0)   /**< \brief (TAL_BRKSTATUS) PPP running, by internal request */
#define   TAL_BRKSTATUS_PPP_INT_HALT_Val  _U_(0x1)   /**< \brief (TAL_BRKSTATUS) PPP halted, by internal request */
#define   TAL_BRKSTATUS_PPP_EXT_RUN_Val   _U_(0x2)   /**< \brief (TAL_BRKSTATUS) PPP running, by external request */
#define   TAL_BRKSTATUS_PPP_EXT_HALT_Val  _U_(0x3)   /**< \brief (TAL_BRKSTATUS) PPP halted, by external request */
...
#define   TAL_BRKSTATUS_EVBRK_INT_RUN_Val _U_(0x0)   /**< \brief (TAL_BRKSTATUS) EVBRK running */
...
#define   TAL_BRKSTATUS_EXTBRK_INT_RUN_Val _U_(0x0)   /**< \brief (TAL_BRKSTATUS) External CPU running, by internal request */
#define   TAL_BRKSTATUS_EXTBRK_INT_HALT_Val _U_(0x1)   /**< \brief (TAL_BRKSTATUS) External CPU halted, by internal request */
#define   TAL_BRKSTATUS_EXTBRK_EXT_RUN_Val _U_(0x2)   /**< \brief (TAL_BRKSTATUS) External CPU running, by external request */
#define   TAL_BRKSTATUS_EXTBRK_EXT_HALT_Val _U_(0x3)   /**< \brief (TAL_BRKSTATUS) External CPU halted, by external request */
...
#define TAL_DMACPUSEL0_MASK         _U_(0x00555555) /**< \brief (TAL_DMACPUSEL0) MASK Register */
...
#define TAL_INTCPUSEL0_MASK         _U_(0x00000000) /**< \brief (TAL_INTCPUSEL0) MASK Register */
