...
typedef struct _DeviceVectors
{
  ...
  void* pfnFPU_Handler;                          /* 61  SAMS70N20B Floating Point Unit Registers (FPU) */
  void* pvReserved62;
  void* pfnRSWDT_Handler;                        /* 63  SAMS70N20B Reinforced Safety Watchdog Timer (RSWDT) */
  void* pfnCCW_Handler;                          /* 64  SAMS70N20B System Control Registers (SystemControl) */
  void* pfnCCF_Handler;                          /* 65  SAMS70N20B System Control Registers (SystemControl) */
  void* pvReserved66;
  void* pvReserved67;
  void* pfnIXC_Handler;                          /* 68  SAMS70N20B Floating Point Unit Registers (FPU) */
