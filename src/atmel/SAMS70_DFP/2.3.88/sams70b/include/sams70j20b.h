...
typedef struct _DeviceVectors
{
  ...
  void* pfnFPU_Handler;                          /* 61  SAMS70J20B Floating Point Unit Registers (FPU) */
  void* pvReserved62;
  void* pfnRSWDT_Handler;                        /* 63  SAMS70J20B Reinforced Safety Watchdog Timer (RSWDT) */
  void* pfnCCW_Handler;                          /* 64  SAMS70J20B System Control Registers (SystemControl) */
  void* pfnCCF_Handler;                          /* 65  SAMS70J20B System Control Registers (SystemControl) */
  void* pvReserved66;
  void* pvReserved67;
  void* pfnIXC_Handler;                          /* 68  SAMS70J20B Floating Point Unit Registers (FPU) */
} DeviceVectors;
#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
