...
typedef struct _DeviceVectors
{
  ...
  void* pfnFPU_Handler;                          /* 61  SAMS70Q19B Floating Point Unit Registers (FPU) */
  ...
  void* pfnCCW_Handler;                          /* 64  SAMS70Q19B System Control Registers (SystemControl) */
  void* pfnCCF_Handler;                          /* 65  SAMS70Q19B System Control Registers (SystemControl) */
  void* pvReserved66;
  void* pvReserved67;
  void* pfnIXC_Handler;                          /* 68  SAMS70Q19B Floating Point Unit Registers (FPU) */
