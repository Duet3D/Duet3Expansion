...
typedef enum IRQn
{
  ...
  TAL_0_IRQn               = 42, /**< 42 SAME53N20A Trigger Allocator (TAL): TAL_BRK */
  TAL_1_IRQn               = 43, /**< 43 SAME53N20A Trigger Allocator (TAL): TAL_IPS_0, TAL_IPS_1 */
...
#define DSU_DID_RESETVALUE    _UL_(0x61830002)
