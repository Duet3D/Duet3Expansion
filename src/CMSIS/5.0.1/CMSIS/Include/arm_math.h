...
#define __CMSIS_GENERIC         /* disable NVIC and Systick functions */
  ...
  #include "../../../../CMSIS/5.0.1/CMSIS/Include/core_cm7.h"
  #define ARM_MATH_DSP
#elif defined (ARM_MATH_CM4)
  #include "../../../../CMSIS/5.0.1/CMSIS/Include/core_cm4.h"
  #define ARM_MATH_DSP
#elif defined (ARM_MATH_CM3)
  #include "../../../../CMSIS/5.0.1/CMSIS/Include/core_cm3.h"
#elif defined (ARM_MATH_CM0)
  #include "../../../../CMSIS/5.0.1/CMSIS/Include/core_cm0.h"
  #define ARM_MATH_CM0_FAMILY
#elif defined (ARM_MATH_CM0PLUS)
  #include "../../../../CMSIS/5.0.1/CMSIS/Include/core_cm0plus.h"
  #define ARM_MATH_CM0_FAMILY
#elif defined (ARM_MATH_ARMV8MBL)
  #include "../../../../CMSIS/5.0.1/CMSIS/Include/core_armv8mbl.h"
  #define ARM_MATH_CM0_FAMILY
#elif defined (ARM_MATH_ARMV8MML)
  #include "../../../../CMSIS/5.0.1/CMSIS/Include/core_armv8mml.h"
