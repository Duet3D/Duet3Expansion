...
public:
	...
	static void UpdateStalledDrivers(DriversBitmap drivers, bool isStalled);
...
inline void EndstopOrZProbe::UpdateStalledDrivers(DriversBitmap drivers, bool isStalled)
{
	if (isStalled)
	{
