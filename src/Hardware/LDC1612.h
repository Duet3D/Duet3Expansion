...
public:
	...
	bool IsChannelReady(uint8_t chan) noexcept;
...
private:
...
#else
	static constexpr float ClockFrequency =	32.0;					// External or internal clock frequency. Assume a tool board or SZP with 32MHz clock generated by the SAMC21
	...
	static constexpr uint16_t DefaultConversionTime = 1000;			// in microseconds
	...
	static constexpr unsigned int resultBitsDropped = 6;			// we drop this number of least significant bits in the result
