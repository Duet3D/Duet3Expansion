...
private:
	static constexpr float ClockFrequency =							// External or internal clock frequency in MHz
#ifdef SAMMYC21
											40.0;					// assume we are using a LDC1612 breakout module with 40MHz crystal oscillator
#else
											32.0;					// assume a tool board or SZP with 32MHz clock generated by the SAMC21
#endif
	...
	static constexpr uint16_t DefaultConversionTime = 800;			// in microseconds
