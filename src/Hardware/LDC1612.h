...
#else
	static constexpr float ClockFrequency =	25.0;					// External or internal clock frequency. Assume a tool board or SZP with 25MHz or 32MHz clock generated by the SAMC21
