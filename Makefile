...
# Phony so the sub-make always gets to decide: an archive left behind by a failed library build is otherwise never retried
.PHONY: $(WORKSPACE)/CoreN2G/SAME5x_CAN_RTOS/libCoreN2G.a \
